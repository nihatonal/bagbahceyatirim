...
import { ArrowRight, Briefcase, ChartNoAxesCombined, Grape, Map } from "lucide-react";
            ...
            return (
              <StaggerItem key={step.key}>
                <article className="group relative h-full">
                  ...
                  <p className="min-h-[104px] text-sm leading-7 text-brand-ivory/68">
                    {t(`${step.key}.description`)}
                  </p>

                  <div className="relative mt-7 h-56 overflow-hidden rounded-xl border border-brand-gold/12 bg-brand-ivory/[0.035]">
                    <Image
                      src={step.image}
